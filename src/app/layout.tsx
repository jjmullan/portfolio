    ...
    <html lang="ko-KR">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        <div className="lg:hidden h-screen flex flex-col items-center justify-center gap-y-1 bg-white">
          ...
          <p className="font-semibold text-lg text-center">모바일 기기를 통한 접근이 불가합니다</p>
          <p className="text-gray-500 text-sm font-semibold text-center">불편하시겠지만 노트북 또는 컴퓨터로 접속해주시기 바랍니다🙂</p>
        </div>
